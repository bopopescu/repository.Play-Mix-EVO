...
home = xbmc.translatePath(os.path.join('special://home/addons/plugin.video.Compus1286/', ''))
tools = xbmc.translatePath(os.path.join('special://home/addons/plugin.video.Compus1286/resources/tools', ''))
addons = xbmc.translatePath(os.path.join('special://home/addons/', ''))
resources = xbmc.translatePath(os.path.join('special://home/addons/plugin.video.Compus1286/resources', ''))
art = xbmc.translatePath(os.path.join('special://home/addons/plugin.video.Compus1286/art', ''))
tmp = xbmc.translatePath(os.path.join('special://home/addons/plugin.video.Compus1286/tmp', ''))
