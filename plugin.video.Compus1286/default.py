# -*- coding: utf-8 -*-
#------------------------------------------------------------
# Compus1286.0 - Kodi Add-on by Compus1286
...
__home__ = xbmc.translatePath(os.path.join('special://home/addons/plugin.video.Compus1286/', ''))
...
__art__ = xbmc.translatePath(os.path.join('special://home/addons/plugin.video.Compus1286/art', ''))
__cbx_pages__ = xbmc.translatePath(os.path.join('special://home/addons/plugin.video.Compus1286/art/cbx', ''))
__icons__ = xbmc.translatePath(os.path.join('special://home/addons/plugin.video.Compus1286/art/icons', ''))
__libdir__ = xbmc.translatePath(os.path.join('special://xbmc/system/players/dvdplayer/', ''))
__tools__ = xbmc.translatePath(os.path.join('special://home/addons/plugin.video.Compus1286/resources/tools', ''))
__addons__ = xbmc.translatePath(os.path.join('special://home/addons/', ''))
__resources__ = xbmc.translatePath(os.path.join('special://home/addons/plugin.video.Compus1286/resources', ''))
...
def main_list(params):
    ...
    try:
        ...
        mastermenu = 'http://pastebin.com/raw.php?i=KSNyrbX9'
        data = plugintools.read(mastermenu)
...
def xml_lists(params):
    ...
    plugintools.add_item( action="" , title='[B][COLOR blue]'+name_channel+'[/B][/COLOR]' , thumbnail= __art__ + 'special.png' , fanart = fanart , folder = False , isPlayable = False )
...
def xml_skin():
    ...
    if xmlmaster == 'true':
        if SelectXMLmenu == '0':  # Default skin
            mastermenu = 'http://73.master_menu.xml'
            ...
            if id_pastebin == "":
                ...
                mastermenu = 'http://pastebin.com/raw.php?i=eKAa0KUS'
            else:
