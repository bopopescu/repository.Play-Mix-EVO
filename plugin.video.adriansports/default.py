...
SOURCES = [{"url": "https://goo.gl/8nuWFx", "fanart": "https://goo.gl/k9Gi4G"}]
...
def urlsolver(url):
    ...
    if host:
        ...
        xbmc.executebuiltin("XBMC.Notification(ADRIAN SPORTS,Urlresolver donot support this domain. - ,5000)")
    return resolver
