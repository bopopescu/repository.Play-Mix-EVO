...
line1 = "  ------BIENVENIDOS A [COLOR blue]...CHAMPIONS LEAGUE Y LA LIGA...[/COLOR]ESTE ADDON ES GRATIS Y ESTA PROHIBIDA SU VENTA.....[COLOR yellow][B]CHAMPIONS LEAGUE Y LA LIGA[/B][/COLOR]'"
...
Base = 'http://koditvonline2016.blogspot.com/p/champions-league-y-la-liga-add-on.html' #    modificar("la ruta de tus listas")

addon = xbmcaddon.Addon('plugin.video.CHAMPIONS LEAGUE  Y LA LIGA') #    modificar("el nombre de tu addons")
