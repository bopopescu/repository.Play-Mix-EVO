...
# PalcoTV utiliza los scripts: t0mm0.common, beautifulsoup, requests, youtube.dl, common.plugin.cache, m3u8 y dateutil.
...
def xml_skin():
    ...
    if xmlmaster == 'true':
        if SelectXMLmenu == '0':  # Default skin
            mastermenu = 'https://dl.dropboxusercontent.com/u/8036850/PalcoTV/PalcoTV-0.3.3.xml'
