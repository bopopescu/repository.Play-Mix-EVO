...
Base = 'http://evilstreams.blogspot.com.es/2016/05/version1.html' #    modificar("la ruta de tus listas")

addon = xbmcaddon.Addon('plugin.video.evilstreams') #    modificar("el nombre de tu addons")
